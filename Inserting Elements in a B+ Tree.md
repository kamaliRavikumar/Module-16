...
## OUTPUT
<img width="1104" height="434" alt="image" src="https://github.com/user-attachments/assets/4a5acf24-7618-4826-999b-4d34c60e4b02" />

```

## RESULT
Thus the Python function `def insert(self, key, value):` to insert elements into a **B+ Tree** is executed successfully.
