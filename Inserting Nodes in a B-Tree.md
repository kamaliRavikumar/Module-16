...
## OUTPUT
<img width="1587" height="414" alt="Screenshot 2025-11-09 213851" src="https://github.com/user-attachments/assets/c56b0f7d-9492-4eaa-8bce-ed8fcd3a418f" />

```

## RESULT
Thus the Python function `def insert(self, k):` to insert the nodes in a **B-Tree** is executed successfully.
