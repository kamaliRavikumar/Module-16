...
class AVL_Tree(object):
	...
	def leftRotate(self, z):
	    ...
	    y.left=z
	    z.right=T2
	    z.height=1+max(self.getHeight(z.right),self.getHeight(z.left))
...
## OUTPUT
<img width="1134" height="252" alt="Screenshot 2025-11-09 214451" src="https://github.com/user-attachments/assets/2c7bcf78-8cc6-4b67-913c-f6d3cf413cdf" />

```

## RESULT
thus the Python function `def leftRotate(self, z):` to perform the left rotation operation in an AVL Tree and insert the element '7' into it is executed successfully.
